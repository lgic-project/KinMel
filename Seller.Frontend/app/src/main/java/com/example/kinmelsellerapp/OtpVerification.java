...
public class OtpVerification extends AppCompatActivity {
    ...
    private void resendOTP(String email) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.PUT, AppStatic.REGENERATE_OTP_API + "?email=" + email,
    ...
    private void verifyAccount(String email, String otp) {
        ...
        // Create a StringRequest for the PUT request
        StringRequest stringRequest = new StringRequest(Request.Method.PUT, AppStatic.VERIFY_ACCOUNT_API + "?email=" + email + "&otp=" + otp,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
    ...
    private void showMessageDialog(String message) {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(OtpVerification.this, SellerLogin.class);
